...
declare module '$env/static/private' {
	...
	export const TEST1_EMAIL: string;
	export const TEST1_PASSWORD: string;
	export const TEST2_EMAIL: string;
	export const TEST2_PASSWORD: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TEST1_EMAIL: string;
		TEST1_PASSWORD: string;
		TEST2_EMAIL: string;
		TEST2_PASSWORD: string;
		TMP: string;
		TMPDIR: string;
		USERDOMAIN: string;
